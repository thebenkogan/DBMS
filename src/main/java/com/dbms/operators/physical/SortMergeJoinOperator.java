...
public class SortMergeJoinOperator extends PhysicalOperator {
    ...
    /** This keeps track of the index (row number) of the sorted right table. */
    private int rightIndex;

    /** Acts as a marker for the last time the leftTuple and rightTuple satisfied the equality join
     * condition. It follows the right SortOperator when we need to find the next equality. It will
     * be -1 after a merge has been completed. */
