...
public class LogicalPlanBuilder {
     ...
     * @param tables tables to place in tree. If aliases exist, then tables consists solely of aliases. Otherwise, tables contains actual table names; tables.length > 1
